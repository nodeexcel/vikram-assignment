...
- [ ] BUG-20260924-1322-17 — Factor schema from FEAT-20260924-1250-03 stores a single ticker and a single direction per factor, but sector and market factors are shared ticker-agnostic state carrying direction, impact, weight and provenance per ticker. Spec §6.5 now gives the explicit shape. Blocks FEAT-20260924-1250-08
