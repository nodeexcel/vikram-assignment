...
app/
  ...
  web/
    ...
    static/
fixtures/
  factors.yaml      # shared, ticker-agnostic (§6.5) — every factor for every ticker, one file
  nvda/             # research.yaml, rules.yaml, catalysts.yaml, scenarios.yaml
  amzn/             # research.yaml, rules.yaml, catalysts.yaml, scenarios.yaml (thin)
